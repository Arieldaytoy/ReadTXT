namespace ReadTXT
{
    ...
    {
        private readonly IMiniModeHost host;
        ...
        public MiniModeForm(IMiniModeHost host)
        {
            this.host = host;
            InitializeComponent();
        }
        ...
        private void InitializeMiniModeForm()
        {
            ...
            {
                string newStatusText = host.GetSpeakingStatus() ?
                    "正在朗读: \r\n" + host.GetCurrentReadingText() :
                    "状态: 已暂停";
            ...
            {
                string newChapterText = "当前章节: " + host.GetCurrentChapter();
            ...
            updateTimer.Tick += (s, ev) =>
            {
                try
                {
                    ...
                    // 更新按钮文本
                    playPauseBtn.Text = host.GetSpeakingStatus() ? "暂停" : "继续";
                ...
                {
                    host.LogStatus($"迷你窗体定时器错误: {ex.Message}");
                }
            };
        ...
        private void BindButtonEvents()
        {
            ...
            {
                if (host.GetSpeakingStatus())
                {
                    host.StopReadingFromMini();
                    playPauseBtn.Text = "继续";
                }
                else
                {
                    host.StartReadingFromMini();
                    playPauseBtn.Text = "暂停";
                }
            };

            // 下一章按钮
            nextChapterBtn.Click += (s, ev) => host.NextChapterFromMini();

            // 主窗口按钮
            restoreBtn.Click += (s, ev) => host.SwitchToMainFromMini();
        ...
        public void StopTimer()
        {
            ...
            {
                host.LogStatus($"停止迷你窗体定时器失败: {ex.Message}");
            }
        }
